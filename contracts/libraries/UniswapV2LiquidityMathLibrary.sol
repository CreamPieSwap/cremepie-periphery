...
library UniswapV2LiquidityMathLibrary {
    ...
    function getLiquidityValue(
        ...
        ICremePiePair pair = ICremePiePair(UniswapV2Library.pairFor(factory, tokenA, tokenB));
        bool feeOn = ICremePieFactory(factory).feeTo() != address(0);
